<?php 
	...
	$header_sticky = isset($de_data['DE_header_sticky']) ? $de_data['DE_header_sticky'] : null;
	$header_no_bg = isset($de_data['DE_header_no_background']) ? $de_data['DE_header_no_background'] : null;
...
<header class="<?php if($header_sticky==1){echo 'sticky';}; if($header_no_bg==1){echo ' no_bg';}?>">
    <div class="container">
		<div class="bg-header">
    	<div class="row">
        	<div class="col-md-12">
            ...
            <div class="col-md-9 menu-container">
                ...
                <div class="clearfix"></div>
                        ...
                        <?php $defaults = array(
                            ...
                            'link_before'     => '',
                            'link_after'      => '',
                            'items_wrap'      => '<ul id="mobile-nav" class="de-menu-mobile">%3$s</ul>',
                            'depth'           => 0,
                            'walker'          => ''
                        ); ?>
                        <?php wp_nav_menu( $defaults ); ?>
