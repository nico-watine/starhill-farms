		...
		while ($wp_query->have_posts()) : $wp_query->the_post();	?>
        	  ...
        	  <li class="col-md-3 box gallery-item <?php
                ...
                <div class="pic_hover">
					...
					<?php if($url!=""){ ?>
						<a href="<?php echo $url; ?>">
							<span class="overlay"></span><?php echo get_the_post_thumbnail($id, "medium", array( 'alt' => false ) ); ?>
						</a>
					<?php }elseif($vid_url!=""){ ?>
						<a class="image" href="<?php echo $vid_url; ?>" rel="prettyPhoto[gallery]" title="<?php the_title();?>">
							<span class="overlay video_play"></span><?php echo get_the_post_thumbnail($id, "medium", array( 'alt' => false ) ); ?>
						</a>
